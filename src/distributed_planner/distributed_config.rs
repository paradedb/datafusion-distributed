...
extensions_options! {
    ...
    pub struct DistributedConfig {
        ...
        /// [crate::WorkerTransport] used to open worker connections and dispatch plans. Defaults to
        /// the Arrow-Flight gRPC transport; embedders can override it with their own transport.
