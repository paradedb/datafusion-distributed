...
mod tests {
    ...
    async fn test_join_agg_hive() -> Result<(), Box<dyn std::error::Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │         DistributedLeafExec:
          │           t0: DataSourceExec: file_groups={4 groups: [[/testdata/join/parquet/dim/d_dkey=A/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=B/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=C/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=D/data0.parquet:<int>..<int>]]}, projection=[env, service, d_dkey], output_partitioning=Hash([d_dkey@2], 4), file_type=parquet, predicate=service@1 = log, pruning_predicate=service_null_count@2 != row_count@3 AND service_min@0 <= log AND log <= service_max@1, required_guarantees=[service in (log)]
          │           t1: DataSourceExec: file_groups={4 groups: [[/testdata/join/parquet/dim/d_dkey=A/data0.parquet:<int>..<int>, /testdata/join/parquet/dim/d_dkey=B/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=B/data0.parquet:<int>..<int>, /testdata/join/parquet/dim/d_dkey=C/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=C/data0.parquet:<int>..<int>, /testdata/join/parquet/dim/d_dkey=D/data0.parquet:<int>..<int>], [/testdata/join/parquet/dim/d_dkey=D/data0.parquet:<int>..<int>]]}, projection=[env, service, d_dkey], output_partitioning=Hash([d_dkey@2], 4), file_type=parquet, predicate=service@1 = log, pruning_predicate=service_null_count@2 != row_count@3 AND service_min@0 <= log AND log <= service_max@1, required_guarantees=[service in (log)]
          │       DistributedLeafExec:
          │         t0: DataSourceExec: file_groups={4 groups: [[/testdata/join/parquet/fact/f_dkey=A/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=C/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=C/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=B/data0.parquet:<int>..<int>]]}, projection=[timestamp, value, f_dkey], output_ordering=[f_dkey@2 ASC NULLS LAST, timestamp@0 ASC NULLS LAST], output_partitioning=Hash([f_dkey@2], 4), file_type=parquet
          │         t1: DataSourceExec: file_groups={4 groups: [[/testdata/join/parquet/fact/f_dkey=B/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=D/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=A/data0.parquet:<int>..<int>], [/testdata/join/parquet/fact/f_dkey=D/data0.parquet:<int>..<int>]]}, projection=[timestamp, value, f_dkey], output_ordering=[f_dkey@2 ASC NULLS LAST, timestamp@0 ASC NULLS LAST], output_partitioning=Hash([f_dkey@2], 4), file_type=parquet
